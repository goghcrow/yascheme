...
(define null '())
(define empty '())
(define void (lambda () (xiao.lang.Procedures/Void)))
...
(define (null? x) (xiao.lang.Procedures/isNull x))
(define (void? x) (.equals (void) x))
(define (pair? x) (xiao.lang.Procedures/isPair x))
(define cons? pair?)
(define (list? x) (instance? xiao.lang.Values$PList x))
