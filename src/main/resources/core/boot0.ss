...
(define-values (throw) (lambda (t) (. xiao.lang.Procedures (throw1 t))))
(define-values (raise) (lambda (msg) (throw (new java.lang.RuntimeException msg))))
(define-values (null?) (lambda (x) (. xiao.lang.Procedures (isNull x))))
(define-values (pair?) (lambda (x) (. xiao.lang.Procedures (isPair x))))
(define-values (list?) (lambda (x) (. xiao.lang.Procedures (isList x))))
(define-values (cons) (lambda (x y) (. xiao.lang.Procedures (cons x y))))
(define-values (car) (lambda (x) (. xiao.lang.Procedures (car x))))
(define-values (cdr) (lambda (x) (. xiao.lang.Procedures (cdr x))))
