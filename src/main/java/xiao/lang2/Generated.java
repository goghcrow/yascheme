    ...
    static void genCoercePrimitive() {
        ...
        for (String numType : numTypes) {
            ...
            if (numType.equals("BigInteger")) {
                System.out.printf("(define (bigint a) (xiao.lang2.Generated/castTo%s a))\n",
                        methodName);
            } else if (numType.equals("BigDecimal")) {
                System.out.printf("(define (bigdec a) (xiao.lang2.Generated/castTo%s a))\n",
                        methodName);
            } else {
                System.out.printf("(define (%s a) (xiao.lang2.Generated/castTo%s a))\n",
                        numType,
                        methodName);
            }
        }
